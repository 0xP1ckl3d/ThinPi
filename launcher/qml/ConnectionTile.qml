...
Rectangle {
    id: tile; property string title; property string subtitle; property string badge; property bool minimized: false; signal activated
    ...
    Column { anchors.fill: parent; anchors.margins: 22; spacing: 10
        ...
        Rectangle { visible: tile.minimized; width: minimizedText.width+18; height: 25; radius: 12; color: theme.accent; Label { id: minimizedText; anchors.centerIn: parent; text: "MINIMIZED · SELECT TO REOPEN"; color: theme.accentText; font.pixelSize: 10; font.bold: true } }
    }
