...
systemd/Xorg/Matchbox kiosk, non-login identity, locked SSH client, isolated admin
browser policy and controller-ticketed maintenance broker common to every platform.
...
repository with path-specific controller allow rules and a throwaway profile.
